 ...
 Ombro = {
    ...
    porcoes: {
        ...
        'Posterior':['Crucifixo Inverso','Remada','Crucifixo inverso polia','Crucifixo Inverso Unilateral polia']
    }
 ...
 Triceps = {
    ...
    porcoes:{
        ...
        'Lateral': ['Triceps polia corda','Triceps polia barra']
    }
}
 ...
 Peitoral = { 
    ...
    porcoes:{
        'Maior': { 
                ...
                'Medio' : ['Supino reto', 'Flexão normal','Voador halter','Voador polia'],
                'Inferior': ['Supino declinado', 'Flexão com a mão no banco','Voador declinado halter','Voador declinado polia','Flexão spider man']
                },
 ...
 Abdomen ={
    ...
    porcoes: {
                'Obliquo':{
                        ...
                        'Externo':['Abd tradicional Bola Pilates','Infra Bola Pilates','Abd Unilateral']
                        },
                'Reto': ['Supra','Militar', 'Prancha spider man'],
...
Quadriceps = {
    ...
    porcoes:{
        ...
        'Lateral':['Leg Press','Leg press pisada aberta','Leg press pisada neutra','Leg press pisada fechada'],
 ...
 Panturrilha = {
    ...
    porcoes: {
        ...
        'Tibial': ['Flexão anterior do pé com barra']
    }
};
//-------------------------------------Treinos especiais-------------------------------------------
 CodromalaciaPatelar = {
    ...
    Quadriceps: ['Leg press com os pés altos na plataforma','Agachamento na maquina','Lounges sem peso'] 
}
